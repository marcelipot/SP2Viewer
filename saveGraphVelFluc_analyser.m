...
set(Fig, 'Name', 'FullScreen Display: Crest & Troughs Graph');
...
if nbRaces == 1;
    GraphPosA1 = [70./FigPos(3), 50./FigPos(4), 1180./FigPos(3), 565./FigPos(4)];
    
elseif nbRaces == 2;
    GraphPosB1 = [70./FigPos(3), 356./FigPos(4), 1180./FigPos(3), 250./FigPos(4)];
    GraphPosB2 = [70./FigPos(3), 50./FigPos(4), 1180./FigPos(3), 250./FigPos(4)];
    
elseif nbRaces == 3;
    GraphPosC1 = [70./FigPos(3), 460./FigPos(4), 1180./FigPos(3), 170./FigPos(4)];
    GraphPosC2 = [70./FigPos(3), 255./FigPos(4), 1180./FigPos(3), 170./FigPos(4)];
    GraphPosC3 = [70./FigPos(3), 40./FigPos(4), 1180./FigPos(3), 170./FigPos(4)];
    
elseif nbRaces == 4;
    GraphPosD1 = [65./FigPos(3), 502./FigPos(4), 1180./FigPos(3), 120./FigPos(4)];
    GraphPosD2 = [65./FigPos(3), 348./FigPos(4), 1180./FigPos(3), 120./FigPos(4)];
    GraphPosD3 = [65./FigPos(3), 194./FigPos(4), 1180./FigPos(3), 120./FigPos(4)];;
    GraphPosD4 = [65./FigPos(3), 40./FigPos(4), 1180./FigPos(3), 120./FigPos(4)];

elseif nbRaces == 5;
    GraphPosE1 = [60./FigPos(3), 543./FigPos(4), 1180./FigPos(3), 102./FigPos(4)];
    GraphPosE2 = [60./FigPos(3), 416./FigPos(4), 1180./FigPos(3), 102./FigPos(4)];
    GraphPosE3 = [60./FigPos(3), 289./FigPos(4), 1180./FigPos(3), 102./FigPos(3)];
    GraphPosE4 = [60./FigPos(3), 162./FigPos(4), 1180./FigPos(3), 102./FigPos(4)];
    GraphPosE5 = [60./FigPos(3), 35./FigPos(4), 1180./FigPos(3), 102./FigPos(4)];

elseif nbRaces == 6;
    GraphPosF1 = [60./FigPos(3), 575./FigPos(4), 1180./FigPos(3), 87./FigPos(4)];
    GraphPosF2 = [60./FigPos(3), 467./FigPos(4), 1180./FigPos(3), 87./FigPos(4)];
    GraphPosF3 = [60./FigPos(3), 359./FigPos(4), 1180./FigPos(3), 87./FigPos(4)];
    GraphPosF4 = [60./FigPos(3), 251./FigPos(4), 1180./FigPos(3), 87./FigPos(4)];
    GraphPosF5 = [60./FigPos(3), 143./FigPos(4), 1180./FigPos(3), 87./FigPos(4)];
    GraphPosF6 = [60./FigPos(3), 35./FigPos(4), 1180./FigPos(3), 87./FigPos(4)];
    
elseif nbRaces == 7;
    GraphPosG1 = [55./FigPos(3), 581./FigPos(4), 1180./FigPos(3), 66./FigPos(4)];
    GraphPosG2 = [55./FigPos(3), 490./FigPos(4), 1180./FigPos(3), 66./FigPos(4)];
    GraphPosG3 = [55./FigPos(3), 399./FigPos(4), 1180./FigPos(3), 66./FigPos(4)];
    GraphPosG4 = [55./FigPos(3), 308./FigPos(4), 1180./FigPos(3), 66./FigPos(4)];
    GraphPosG5 = [55./FigPos(3), 217./FigPos(4), 1180./FigPos(3), 66./FigPos(4)];
    GraphPosG6 = [55./FigPos(3), 126./FigPos(4), 1180./FigPos(3), 66./FigPos(4)];
    GraphPosG7 = [55./FigPos(3), 35./FigPos(4), 1180./FigPos(3), 66./FigPos(4)];
    
elseif nbRaces == 8;
    GraphPosH1 = [55./FigPos(3), 595./FigPos(4), 1180./FigPos(3), 58./FigPos(4)];
    GraphPosH2 = [55./FigPos(3), 515./FigPos(4), 1180./FigPos(3), 58./FigPos(4)];
    GraphPosH3 = [55./FigPos(3), 435./FigPos(4), 1180./FigPos(3), 58./FigPos(4)];
    GraphPosH4 = [55./FigPos(3), 355./FigPos(4), 1180./FigPos(3), 58./FigPos(4)];
    GraphPosH5 = [55./FigPos(3), 275./FigPos(4), 1180./FigPos(3), 58./FigPos(4)];
    GraphPosH6 = [55./FigPos(3), 195./FigPos(4), 1180./FigPos(3), 58./FigPos(4)];
    GraphPosH7 = [55./FigPos(3), 115./FigPos(4), 1180./FigPos(3), 58./FigPos(4)];
    GraphPosH8 = [55./FigPos(3), 35./FigPos(4), 1180./FigPos(3), 58./FigPos(4)];
end;
...
for race = 1:nbRaces;
    ...
    eval(['posEC = GraphPos' letter num2str(race) ';']);

    axesflucVelEC_analyser = axes('parent', Fig, 'units', 'normalized', ...
    ...
    if handles.FlucDisplayLapIni_analyser == 1;
        cycleIniAxe = 1;
    else;
        cycleIniAxe = sum(nbCycleTot(1:handles.FlucDisplayLapIni_analyser-1));
    end;
    cycleEndAxe = sum(nbCycleTot(1:handles.FlucDisplayLapEnd_analyser));
    ...
    if race == 1;
        ...
        axesXTitleflucVel = axes('parent', Fig, 'Position', [offsetLeftXtitle, offsetBottomXtitle, widthXtitle, heightXtitle], 'units', 'Normalized', ...
        ...
        axesYTitleflucVel = axes('parent', Fig, 'Position', [offsetLeftXtitle-0.14, offsetbottom./FigPos(4), widthA, (TopPointY-offsetbottom)./FigPos(4)], 'units', 'Normalized', ...
        ...
        axesLegendflucVel = axes('parent', Fig, 'Position', [leftPos bottomPos widthPos heightPos], 'units', 'Normalized', ...
            'Visible', 'on', 'color', [0 0 0], 'xcolor', [0 0 0], 'ycolor', [0 0 0], ...
            'xtick', [], 'xticklabel', [], 'ytick', [], 'yticklabel', []);
