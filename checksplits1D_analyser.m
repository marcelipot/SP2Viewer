function [] = checksplits1D_analyser(varargin);


handles = guidata(gcf);
StatusEC = get(handles.AminationStatus_analyser, 'String');

if get(handles.splits1D_check_analyser, 'Value') == 0;
    set(handles.splits1D_check_analyser, 'Value', 1);
    return;
end;

if strcmpi(StatusEC, 'Play');
    set(handles.AminationStatus_analyser, 'String', 'SplitsCheck1D');
    val = get(handles.splits1D_check_analyser, 'Value');
    if val == 1;
        set(handles.splits1D_check_analyser, 'Value', 1);
...
if NewSplits1D == handles.CurrentvalueSplits1D;
    set(handles.splits1D_check_analyser, 'Value', 1);
    return;
end;
set(handles.splits2D_check_analyser, 'Value', 0);
...
handles.CurrentvalueSplits1D = NewSplits1D;
