...
if isempty(databaseCurrent) == 0;
    ...
    if isempty(databaseCurrent) == 1;
        set(handles.AthleteName_list_benchmark, 'String', 'None', 'value', 1);
    else;
        ...
        listRaces = {};
        listRaces{1,1} = '----  SB  ----';
        listRaces{2,1} = 'SB 2022-2023';
        listRaces{3,1} = 'SB 2021-2022';
        listRaces{4,1} = 'SB 2020-2021';
        listRaces{5,1} = 'SB 2019-2020';
        listRaces{6,1} = 'SB 2018-2019';
        listRaces{7,1} = 'SB 2017-2018';
        listRaces{8,1} = '----  CB  ----';
        listRaces{9,1} = 'CB Paris 2024';
        listRaces{10,1} = 'CB Tokyo 2021';
        listRaces{11,1} = '----  PB  ----';
        listRaces{12,1} = 'PB';
