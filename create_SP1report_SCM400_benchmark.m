...
%-----------------------------Create Slider--------------------------------
% hdef = uipanel('parent', hdef, 'Visible', 'on', 'units', 'pixels', ...
%     'position', [1, resolution(2)-(0.1*resolution(2))-1420, 1200, 1410], ...
%     'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0]);
% set(hdef, 'fontunits', 'normalized', 'units', 'normalized');
% window_size = [1, resolution(2)-1410, 1200, 1410];
% handles2.window_size = get(hdef, 'Position');
