function [] = updatedistri_analyser(varargin);
...
%     posC3 = [550./FigPos(3), 60./FigPos(4), 450./FigPos(3), 260./FigPos(4)];
    posC1 = [0.1953 0.4665 0.2930 0.2923];
    posC2 = [0.5208 0.4665 0.2930 0.2923];
    posC3 = [0.3581 0.0674 0.2930 0.2923];
...
%     posD4 = [800./FigPos(3), 60./FigPos(4), 450./FigPos(3), 260./FigPos(4)];
    posD1 = [0.1823 0.4665 0.2930 0.2923];
    posD2 = [0.5208 0.4665 0.2930 0.2923];
    posD3 = [0.1823 0.0674 0.2930 0.2923];
    posD4 = [0.5208 0.0674 0.2930 0.2923];

elseif nbRaces == 5;
%     posE1 = [270./FigPos(3), 415./FigPos(4), 295./FigPos(3), 260./FigPos(4)];
...
%     posE5 = [810./FigPos(3), 60./FigPos(4), 295./FigPos(3), 260./FigPos(4)];
    posE1 = [0.1758 0.4665 0.1921 0.2923];
    posE2 = [0.4134 0.4665 0.1921 0.2923];
    posE3 = [0.6380 0.4665 0.1921 0.2923];
    posE4 = [0.2799 0.0674 0.1921 0.2923];
    posE5 = [0.5273 0.0674 0.1921 0.2923];
...
%     posF6 = [980./FigPos(3), 60./FigPos(4), 295./FigPos(3), 260./FigPos(4)];
    posF1 = [0.1758 0.4665 0.1921 0.2923];
    posF2 = [0.4134 0.4665 0.1921 0.2923];
    posF3 = [0.6380 0.4665 0.1921 0.2923];
    posF4 = [0.1758 0.0674 0.1921 0.2923];
    posF5 = [0.4134 0.0674 0.1921 0.2923];
    posF6 = [0.6380 0.0674 0.1921 0.2923];
...
%     posG7 = [635./FigPos(3), 50./FigPos(4), 295./FigPos(3), 160./FigPos(4)];
    posG1 = [0.1758 0.5958 0.1921 0.1799];
    posG2 = [0.4134 0.5958 0.1921 0.1799];
    posG3 = [0.6380 0.5958 0.1921 0.1799];
    posG4 = [0.1758 0.3260 0.1921 0.1799];
    posG5 = [0.4134 0.3260 0.1921 0.1799];
    posG6 = [0.6380 0.3260 0.1921 0.1799];
    posG7 = [0.4134 0.0562 0.1921 0.1799];
...
%     posH8 = [810./FigPos(3), 50./FigPos(4), 295./FigPos(3), 160./FigPos(4)];
    posH1 = [0.1758 0.5958 0.1921 0.1799];
    posH2 = [0.4134 0.5958 0.1921 0.1799];
    posH3 = [0.6380 0.5958 0.1921 0.1799];
    posH4 = [0.1758 0.3260 0.1921 0.1799];
    posH5 = [0.4134 0.3260 0.1921 0.1799];
    posH6 = [0.6380 0.3260 0.1921 0.1799];
    posH7 = [0.2799 0.0562 0.1921 0.1799];
    posH8 = [0.5273 0.0562 0.1921 0.1799];
end;
...
for race = 1:nbRaces;
    ...
    axesdistriVelEC_analyser = axes('parent', handles.hf_w1_welcome, 'units', 'normalized', ...
    ...
    axesXTitledistriVel = axes('parent', handles.hf_w1_welcome, 'Position', [posEC(1), posEC(2)-0.05, posEC(3), 0.02], 'units', 'Normalized', ...
    ...
    axesYTitledistriVel = axes('parent', handles.hf_w1_welcome, 'Position', [posEC(1)-offsetX, posEC(2), 0.02, posEC(4)], 'units', 'Normalized', ...
    ...
    if race == 1;
        ...
        axesLegenddistriVel = axes('parent', handles.hf_w1_welcome, 'Position', [leftPos bottomPos widthPos heightPos], 'units', 'Normalized', ...
            'Visible', 'on', 'color', [0 0 0], 'xcolor', [0 0 0], 'ycolor', [0 0 0], ...
            'xtick', [], 'xticklabel', [], 'ytick', [], 'yticklabel', []);
        ...
        hold off;
        handles.axesLegenddistriVel = axesLegenddistriVel;
    end;
    %----
    

    %---Save data for deletion
    eval(['handles.axesdistriVel' num2str(race) '_analyser = axesdistriVelEC_analyser;']);
    eval(['handles.gtitdistriVel' num2str(race) '_analyser = gtitdistriVelEC;']);
    eval(['handles.axesXTitledistriVel' num2str(race) '_analyser = axesXTitledistriVel;']);
    eval(['handles.axesYTitledistriVel' num2str(race) '_analyser = axesYTitledistriVel;']);
    %----
