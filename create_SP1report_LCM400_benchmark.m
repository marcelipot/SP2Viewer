...
%     window_size = floor([(resolution(1)-1200)./2 0.0485*resolution(2) 1200 resolution(2)-(0.08*resolution(2))]);
...
if strcmpi(source, 'display') == 1;
    ...
    if window_size(3) < 1140 | window_size(4) < 865;
        h = warndlg('Screen resolution below [1140 865]. Display could be impacted', 'Warning');
        waitfor(h);
    end;
...
lapEC = 1;
for iter = 1:2:length(validIndex);
    valEC1 = dataTableBreath(validIndex(iter), 3);
    valEC2 = dataTableBreath(validIndex(iter+1), 3);
    valEC = roundn(valEC1,0) + roundn(valEC2,0);
...
elseif strcmpi(answerReport, 'SP2') == 1;
    %400m race so take col 4 for the speed
    VelLap = [];
    interpVel = 0;
    colinterest_Speed = 4;
...
DPSTOT = [];
if strcmpi(answerReport, 'SP1') == 1 | strcmpi(answerReport, 'GE') == 1;
    %it's a 400 so take col = 7 for short intervals
    colinterest_DPS = 7;
...
elseif strcmpi(answerReport, 'SP2') == 1;
    %it's a 400 so take col = 10 for short intervals
    validIndex = [5 10 15 20 25 30 35 40 45 50 55 60 65 70 75 80];
    DPSLap = [];
    interpDPS = 0;
    colinterest_DPS = 10;
...
if strcmpi(answerReport, 'SP1') == 1 | strcmpi(answerReport, 'GE') == 1;
    ...
    %It's a 400m so take col = 3 for short intervals
    validIndex = [5 10 15 20 25 30 35 40 45 50 55 60 65 70 75 80];
    SRLap = [];
    interpSR = 0;
    colinterest_SR = 3;
...
elseif strcmpi(answerReport, 'SP2') == 1;
    ...
    %It's a 400m so take col = 7 for short intervals
    validIndex = [5 10 15 20 25 30 35 40 45 50 55 60 65 70 75 80];
    SRLap = [];
    interpSR = 0;
    colinterest_SR = 7;
...
if Source == 1 | Source == 3;
    %It's a 400m so take col = 10 for short intervals
    colinterest_SC = 10;
...
elseif Source == 2;
    %It's a 400m so take col = 15 for short intervals
    indexLapINI = 1;
    for lapEC = 1:NbLap;
        indexLapEND = find(dataTableRefDist == keyDist(lapEC));
...
txtLegend_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [40, window_size(4)-175, window_size(3)-60, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue1_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [30, window_size(4)-220, window_size(3)-60, 50], 'HorizontalAlignment', 'left', ...
...
txtTitle1_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [40, window_size(4)-208, 280, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtTitle2_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [320, window_size(4)-208, 280, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Normal', 'Fontsize', font4, 'String', txt);
...
txtTitle3_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [600, window_size(4)-208, 280, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Normal', 'Fontsize', font4, 'String', txt);
...
txtTitle4_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [880, window_size(4)-208, 280, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Normal', 'Fontsize', font4, 'String', txt);
...
txtBlock_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [40, window_size(4)-250, 150, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlock2_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [190, window_size(4)-250, 150, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Normal', 'Fontsize', font4, 'String', txt);
...
txtStartBOTime1_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [320, window_size(4)-250, 170, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Bold', 'Fontsize', font4, 'String', txt);
...
txtStartBOTime2_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [490, window_size(4)-250, 170, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Normal', 'Fontsize', font4, 'String', txt);
...
txtOut_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [600, window_size(4)-250, 100, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Bold', 'Fontsize', font4, 'String', txt);
...
txtOut2_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [730, window_size(4)-250, 150, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Normal', 'Fontsize', font4, 'String', txt);
...
txtTT_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [880, window_size(4)-250, 150, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Bold', 'Fontsize', font4, 'String', txt);
...
txtTT2_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [1030, window_size(4)-250, 100, 20], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Normal', 'Fontsize', font4, 'String', txt);
...
txtBlue2_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [30, window_size(4)-360, window_size(3)-60, 50], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
...
txtBlue5_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [30, window_size(4)-345, 120, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue6a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [150, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue6b_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [150, window_size(4)-360, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue7a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [210, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue7b_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [210, window_size(4)-360, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue8a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [270, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue8b_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [270, window_size(4)-360, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue9_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [330, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue10_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [390, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue11_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [450, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue12a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [510, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue12b_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [510, window_size(4)-360, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'normal', 'Fontsize', font3, 'String', '(m)');
...
txtBlue13a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [570, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue13b_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [570, window_size(4)-360, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue14a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [630, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue14b_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [630, window_size(4)-360, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'normal', 'Fontsize', font3, 'String', '(s)');
...
txtBlue15a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [690, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue15b_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [690, window_size(4)-360, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'normal', 'Fontsize', font3, 'String', '(s)');
...
txtBlue16_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [750, window_size(4)-345, 60, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue17_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [810, window_size(4)-345, 72, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue18_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [882 window_size(4)-345, 72, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue19_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [954, window_size(4)-345, 72, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue20_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [1026, window_size(4)-345, 72, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtBlue21_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [1098, window_size(4)-345, 72, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.7 0.88 0.9], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
txtCol1a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [30, window_size(4)-390, 120, 30], 'HorizontalAlignment', 'left', ...
    'BackgroundColor', [1 1 1], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
    'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
...
txtCol1b_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [30, window_size(4)-420, 120, 30], 'HorizontalAlignment', 'left', ...
...
txtCol1Q_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [30, window_size(4)-865, 120, 20], 'HorizontalAlignment', 'center', ...
    'BackgroundColor', [0.97 0.97 0.94], 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
position1INI = [150, window_size(4)-390, 60, 30];
position2INI = [150, window_size(4)-385, 60, 20];
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol2a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [150, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol2a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol2A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [150, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
position1INI = [210, window_size(4)-390, 60, 30];
position2INI = [210, window_size(4)-385, 60, 20];
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol3a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [210, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol3a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol3A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [210, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
position1INI = [270, window_size(4)-390, 60, 30];
position2INI = [270, window_size(4)-385, 60, 20];
ColorOdd = [0.98 0.97 0.91];
ColorEven = [0.88 0.89 0.89];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol4a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [270, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol4a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol4A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [270, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
position1INI = [330, window_size(4)-390, 60, 30];
position2INI = [330, window_size(4)-385, 60, 20];
ColorOdd = [0.98 0.97 0.91];
ColorEven = [0.88 0.89 0.89];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol5a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [330, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol5a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol5A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [330, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol5A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
position1INI = [390, window_size(4)-390, 60, 30];
position2INI = [390, window_size(4)-385, 60, 20];
ColorOdd = [0.98 1 1];
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol6a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [390, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol6a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol6A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [390, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol6A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
position1INI = [450, window_size(4)-390, 60, 30];
position2INI = [450, window_size(4)-385, 60, 20];
ColorOdd = [0.98 1 1];
ColorEven = [0.87 0.91 0.92];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol7a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [450, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol7a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol7A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [450, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol7A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
position1INI = [510, window_size(4)-390, 60, 30];
position2INI = [510, window_size(4)-385, 60, 20];
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol8a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [510, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol8a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol8A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [510, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol8A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
position1INI = [569, window_size(4)-390, 62, 30];
position2INI = [569, window_size(4)-385, 62, 20];
ColorOdd = [0.97 0.96 0.98];
ColorEven = [0.85 0.89 0.93];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol9a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [569, window_size(4)-870, 62, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol9a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol9A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [569, window_size(4)-865, 62, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
position1INI = [630, window_size(4)-390, 60, 30];
position2INI = [630, window_size(4)-385, 60, 20];
ColorOdd = [0.97 0.96 0.98];
ColorEven = [0.85 0.89 0.93];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol10a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [630, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol10a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol10A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [630, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
position1INI = [690, window_size(4)-390, 60, 30];
position2INI = [690, window_size(4)-385, 60, 20];
ColorOdd = [0.97 0.96 0.98];
ColorEven = [0.85 0.89 0.93];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol11a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [690, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol11a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol11A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [690, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
...
position1INI = [750, window_size(4)-390, 60, 30];
position2INI = [750, window_size(4)-385, 60, 20];
ColorOdd = [0.97 0.96 0.98];
ColorEven = [0.85 0.89 0.93];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol12a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [750, window_size(4)-870, 60, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol12a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol12A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [750, window_size(4)-865, 60, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol12A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
position1INI = [810, window_size(4)-390, 72, 30];
position2INI = [810, window_size(4)-385, 72, 20];
ColorOdd = [0.97 0.96 0.98];
ColorEven = [0.85 0.89 0.93];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol13a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [810, window_size(4)-870, 72, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol13a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol13A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [810, window_size(4)-865, 72, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol13A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
position1INI = [882, window_size(4)-390, 72, 30];
position2INI = [882, window_size(4)-385, 72, 20];
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol14a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [882, window_size(4)-870, 72, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol14a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol14A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [882, window_size(4)-865, 72, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol14A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
position1INI = [954, window_size(4)-390, 72, 30];
position2INI = [954, window_size(4)-385, 72, 20];
ColorOdd = [1 0.99 0.94];
ColorEven = [0.89 0.93 0.89];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol15a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [954, window_size(4)-870, 72, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol15a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol15A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [954, window_size(4)-865, 72, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol15A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
position1INI = [1026, window_size(4)-390, 72, 30];
position2INI = [1026, window_size(4)-385, 72, 20];
ColorOdd = [1 0.99 0.94];
ColorEven = [0.89 0.93 0.89];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol16a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [1026, window_size(4)-870, 72, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol16a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol16A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [1026, window_size(4)-865, 72, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol16A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
position1INI = [1098, window_size(4)-390, 72, 30];
position2INI = [1098, window_size(4)-385, 72, 20];
ColorOdd = [1 0.99 0.94];
ColorEven = [0.89 0.93 0.89];
ColorEnd = [0.95 0.95 0.83];
iter = 0;
...
for i = 1:length(KeyDist)+1;
    ...
    if i == length(KeyDist)+1;
        txtCol17a_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [1098, window_size(4)-870, 72, 30], 'HorizontalAlignment', 'left', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol17a_pdf, 'fontunits', 'normalized', 'units', 'normalized');
        txtCol17A_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
            'position', [1098, window_size(4)-865, 72, 20], 'HorizontalAlignment', 'center', ...
            'BackgroundColor', ColorEnd, 'ForegroundColor', [0 0 0], 'FontName', 'Arial', ...
            'FontWeight', 'Normal', 'Fontsize', font4, 'String', '');
        set(txtCol17A_pdf, 'fontunits', 'normalized', 'units', 'normalized');
    else;
...
txtBlack_pdf = uicontrol('parent', hdef, 'Style', 'Text', 'Visible', 'on', 'units', 'pixels', ...
    'position', [30, window_size(4)-870, 1140, 1], 'HorizontalAlignment', 'left', ...
