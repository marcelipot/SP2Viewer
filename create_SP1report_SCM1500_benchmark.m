...
if strcmpi(answerReport, 'SP1') == 1 | strcmpi(answerReport, 'GE') == 1;
    ...
    SplitLap33 = timeSecToStr2(dataTablePacing(165,colinterest_Splits) - dataTablePacing(160,colinterest_Splits));
    SplitLap34 = timeSecToStr2(dataTablePacing(170,colinterest_Splits) - dataTablePacing(165,colinterest_Splits));
    SplitLap35 = timeSecToStr2(dataTablePacing(175,colinterest_Splits) - dataTablePacing(170,colinterest_Splits));
    SplitLap36 = timeSecToStr2(dataTablePacing(180,colinterest_Splits) - dataTablePacing(175,colinterest_Splits));
    SplitLap37 = timeSecToStr2(dataTablePacing(185,colinterest_Splits) - dataTablePacing(180,colinterest_Splits));
    SplitLap38 = timeSecToStr2(dataTablePacing(190,colinterest_Splits) - dataTablePacing(185,colinterest_Splits));
    SplitLap39 = timeSecToStr2(dataTablePacing(195,colinterest_Splits) - dataTablePacing(190,colinterest_Splits));
    SplitLap40 = timeSecToStr2(dataTablePacing(200,colinterest_Splits) - dataTablePacing(195,colinterest_Splits));
    SplitLap41 = timeSecToStr2(dataTablePacing(205,colinterest_Splits) - dataTablePacing(200,colinterest_Splits));
    SplitLap42 = timeSecToStr2(dataTablePacing(210,colinterest_Splits) - dataTablePacing(205,colinterest_Splits));
    SplitLap43 = timeSecToStr2(dataTablePacing(215,colinterest_Splits) - dataTablePacing(210,colinterest_Splits));
    SplitLap44 = timeSecToStr2(dataTablePacing(220,colinterest_Splits) - dataTablePacing(215,colinterest_Splits));
    SplitLap45 = timeSecToStr2(dataTablePacing(225,colinterest_Splits) - dataTablePacing(220,colinterest_Splits));
    SplitLap46 = timeSecToStr2(dataTablePacing(230,colinterest_Splits) - dataTablePacing(225,colinterest_Splits));
    SplitLap47 = timeSecToStr2(dataTablePacing(235,colinterest_Splits) - dataTablePacing(230,colinterest_Splits));
    SplitLap48 = timeSecToStr2(dataTablePacing(240,colinterest_Splits) - dataTablePacing(235,colinterest_Splits));
    SplitLap49 = timeSecToStr2(dataTablePacing(245,colinterest_Splits) - dataTablePacing(240,colinterest_Splits));
    SplitLap50 = timeSecToStr2(dataTablePacing(250,colinterest_Splits) - dataTablePacing(245,colinterest_Splits));
    SplitLap51 = timeSecToStr2(dataTablePacing(255,colinterest_Splits) - dataTablePacing(250,colinterest_Splits));
    SplitLap52 = timeSecToStr2(dataTablePacing(260,colinterest_Splits) - dataTablePacing(255,colinterest_Splits));
    SplitLap53 = timeSecToStr2(dataTablePacing(265,colinterest_Splits) - dataTablePacing(260,colinterest_Splits));
    SplitLap54 = timeSecToStr2(dataTablePacing(270,colinterest_Splits) - dataTablePacing(265,colinterest_Splits));
    SplitLap55 = timeSecToStr2(dataTablePacing(275,colinterest_Splits) - dataTablePacing(270,colinterest_Splits));
    SplitLap56 = timeSecToStr2(dataTablePacing(280,colinterest_Splits) - dataTablePacing(275,colinterest_Splits));
    SplitLap57 = timeSecToStr2(dataTablePacing(285,colinterest_Splits) - dataTablePacing(280,colinterest_Splits));
    SplitLap58 = timeSecToStr2(dataTablePacing(290,colinterest_Splits) - dataTablePacing(285,colinterest_Splits));
    SplitLap59 = timeSecToStr2(dataTablePacing(295,colinterest_Splits) - dataTablePacing(290,colinterest_Splits));
    SplitLap60 = timeSecToStr2(dataTablePacing(300,colinterest_Splits) - dataTablePacing(295,colinterest_Splits));
...
elseif strcmpi(answerReport, 'SP2') == 1;
    ...
    SplitLap33 = timeSecToStr2(dataTableAverage{165,13}-dataTableAverage{160,13});
    SplitLap34 = timeSecToStr2(dataTableAverage{170,13}-dataTableAverage{165,13});
    SplitLap35 = timeSecToStr2(dataTableAverage{175,13}-dataTableAverage{170,13});
    SplitLap36 = timeSecToStr2(dataTableAverage{180,13}-dataTableAverage{175,13});
    SplitLap37 = timeSecToStr2(dataTableAverage{185,13}-dataTableAverage{180,13});
    SplitLap38 = timeSecToStr2(dataTableAverage{190,13}-dataTableAverage{185,13});
    SplitLap39 = timeSecToStr2(dataTableAverage{195,13}-dataTableAverage{190,13});
    SplitLap40 = timeSecToStr2(dataTableAverage{200,13}-dataTableAverage{195,13});
    SplitLap41 = timeSecToStr2(dataTableAverage{205,13}-dataTableAverage{200,13});
    SplitLap42 = timeSecToStr2(dataTableAverage{210,13}-dataTableAverage{205,13});
    SplitLap43 = timeSecToStr2(dataTableAverage{215,13}-dataTableAverage{210,13});
    SplitLap44 = timeSecToStr2(dataTableAverage{220,13}-dataTableAverage{215,13});
    SplitLap45 = timeSecToStr2(dataTableAverage{225,13}-dataTableAverage{220,13});
    SplitLap46 = timeSecToStr2(dataTableAverage{230,13}-dataTableAverage{225,13});
    SplitLap47 = timeSecToStr2(dataTableAverage{235,13}-dataTableAverage{230,13});
    SplitLap48 = timeSecToStr2(dataTableAverage{240,13}-dataTableAverage{235,13});
    SplitLap49 = timeSecToStr2(dataTableAverage{245,13}-dataTableAverage{240,13});
    SplitLap50 = timeSecToStr2(dataTableAverage{250,13}-dataTableAverage{245,13});
    SplitLap51 = timeSecToStr2(dataTableAverage{255,13}-dataTableAverage{250,13});
    SplitLap52 = timeSecToStr2(dataTableAverage{260,13}-dataTableAverage{255,13});
    SplitLap53 = timeSecToStr2(dataTableAverage{265,13}-dataTableAverage{260,13});
    SplitLap54 = timeSecToStr2(dataTableAverage{270,13}-dataTableAverage{265,13});
    SplitLap55 = timeSecToStr2(dataTableAverage{275,13}-dataTableAverage{270,13});
    SplitLap56 = timeSecToStr2(dataTableAverage{280,13}-dataTableAverage{275,13});
    SplitLap57 = timeSecToStr2(dataTableAverage{285,13}-dataTableAverage{280,13});
    SplitLap58 = timeSecToStr2(dataTableAverage{290,13}-dataTableAverage{285,13});
    SplitLap59 = timeSecToStr2(dataTableAverage{295,13}-dataTableAverage{290,13});
    SplitLap60 = timeSecToStr2(dataTableAverage{300,13}-dataTableAverage{295,13});
...
if strcmpi(answerReport, 'SP1') == 1 | strcmpi(answerReport, 'GE') == 1;
    locTurnData = [32 40 48 56 64 72 80 88 96 104 112 120 128 136 144 ...
            ...
            264 272 280 288 296 304 312 320 328 336 344 352 360 368 ...
...
Turn32BODist = roundn(BOAllINI(33,2),-1);
Turn32BOTime = roundn(BOAllINI(33,1),-2);
Turn33BODist = roundn(BOAllINI(34,2),-1);
Turn33BOTime = roundn(BOAllINI(34,1),-2);
Turn34BODist = roundn(BOAllINI(35,2),-1);
Turn34BOTime = roundn(BOAllINI(35,1),-2);
Turn35BODist = roundn(BOAllINI(36,2),-1);
Turn35BOTime = roundn(BOAllINI(36,1),-2);
Turn36BODist = roundn(BOAllINI(37,2),-1);
Turn36BOTime = roundn(BOAllINI(37,1),-2);
Turn37BODist = roundn(BOAllINI(38,2),-1);
Turn37BOTime = roundn(BOAllINI(38,1),-2);
Turn38BODist = roundn(BOAllINI(39,2),-1);
Turn38BOTime = roundn(BOAllINI(39,1),-2);
Turn39BODist = roundn(BOAllINI(40,2),-1);
Turn39BOTime = roundn(BOAllINI(40,1),-2);
Turn40BODist = roundn(BOAllINI(41,2),-1);
Turn40BOTime = roundn(BOAllINI(41,1),-2);
Turn41BODist = roundn(BOAllINI(42,2),-1);
Turn41BOTime = roundn(BOAllINI(42,1),-2);
Turn42BODist = roundn(BOAllINI(43,2),-1);
Turn42BOTime = roundn(BOAllINI(43,1),-2);
Turn43BODist = roundn(BOAllINI(44,2),-1);
Turn43BOTime = roundn(BOAllINI(44,1),-2);
Turn44BODist = roundn(BOAllINI(45,2),-1);
Turn44BOTime = roundn(BOAllINI(45,1),-2);
Turn45BODist = roundn(BOAllINI(46,2),-1);
Turn45BOTime = roundn(BOAllINI(46,1),-2);
Turn46BODist = roundn(BOAllINI(47,2),-1);
Turn46BOTime = roundn(BOAllINI(47,1),-2);
Turn47BODist = roundn(BOAllINI(48,2),-1);
Turn47BOTime = roundn(BOAllINI(48,1),-2);
Turn48BODist = roundn(BOAllINI(49,2),-1);
Turn48BOTime = roundn(BOAllINI(49,1),-2);
Turn49BODist = roundn(BOAllINI(50,2),-1);
Turn49BOTime = roundn(BOAllINI(50,1),-2);
Turn50BODist = roundn(BOAllINI(51,2),-1);
Turn50BOTime = roundn(BOAllINI(51,1),-2);
Turn51BODist = roundn(BOAllINI(52,2),-1);
Turn51BOTime = roundn(BOAllINI(52,1),-2);
Turn52BODist = roundn(BOAllINI(53,2),-1);
Turn52BOTime = roundn(BOAllINI(53,1),-2);
Turn53BODist = roundn(BOAllINI(54,2),-1);
Turn53BOTime = roundn(BOAllINI(54,1),-2);
Turn54BODist = roundn(BOAllINI(55,2),-1);
Turn54BOTime = roundn(BOAllINI(55,1),-2);
Turn55BODist = roundn(BOAllINI(56,2),-1);
Turn55BOTime = roundn(BOAllINI(56,1),-2);
Turn56BODist = roundn(BOAllINI(57,2),-1);
Turn56BOTime = roundn(BOAllINI(57,1),-2);
Turn57BODist = roundn(BOAllINI(58,2),-1);
Turn57BOTime = roundn(BOAllINI(58,1),-2);
Turn58BODist = roundn(BOAllINI(59,2),-1);
Turn58BOTime = roundn(BOAllINI(59,1),-2);
Turn59BODist = roundn(BOAllINI(60,2),-1);
Turn59BOTime = roundn(BOAllINI(60,1),-2);
...
KickCountLap33 = BOAllINI(33,3);
KickCountLap34 = BOAllINI(34,3);
KickCountLap35 = BOAllINI(35,3);
KickCountLap36 = BOAllINI(36,3);
KickCountLap37 = BOAllINI(37,3);
KickCountLap38 = BOAllINI(38,3);
KickCountLap39 = BOAllINI(39,3);
KickCountLap40 = BOAllINI(40,3);
KickCountLap41 = BOAllINI(41,3);
KickCountLap42 = BOAllINI(42,3);
KickCountLap43 = BOAllINI(43,3);
KickCountLap44 = BOAllINI(44,3);
KickCountLap45 = BOAllINI(45,3);
KickCountLap46 = BOAllINI(46,3);
KickCountLap47 = BOAllINI(47,3);
KickCountLap48 = BOAllINI(48,3);
KickCountLap49 = BOAllINI(49,3);
KickCountLap50 = BOAllINI(50,3);
KickCountLap51 = BOAllINI(51,3);
KickCountLap52 = BOAllINI(52,3);
KickCountLap53 = BOAllINI(53,3);
KickCountLap54 = BOAllINI(54,3);
KickCountLap55 = BOAllINI(55,3);
KickCountLap56 = BOAllINI(56,3);
KickCountLap57 = BOAllINI(57,3);
KickCountLap58 = BOAllINI(58,3);
KickCountLap59 = BOAllINI(59,3);
KickCountLap60 = BOAllINI(60,3);
